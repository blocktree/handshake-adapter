...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO HNS", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W1Qa6XCkEY6BeGPbyRvckGb6jLBiHDHTZ4")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	tm := testInitWalletManager()
	walletID := "W1Qa6XCkEY6BeGPbyRvckGb6jLBiHDHTZ4"
	account := &openwallet.AssetsAccount{Alias: "mainnetHNS", WalletID: walletID, Required: 1, Symbol: "HNS", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "W1Qa6XCkEY6BeGPbyRvckGb6jLBiHDHTZ4"
	accountID := "FsrUjBdRwjYUtMZ3cR26zDfdV84d8jP5Fc6twAXxsSSu"
...
hs1qustwjwk0arg4rzdtsue062kcqlzpzy4zm2hvnr

hs1qd3jn3mwhry65k8cq2semgxdwrqlg9mmt862c2k

hs1qryhxw8j2rcqmn8j7twatj06vluecmrs30u5ncc
*/
