...
type HNSBlockScanNotificationObject interface {

	//BlockScanNotify 新区块扫描完成通知
	//@required
	HNSBlockScanNotify(block *Block, txs []*Transaction) error
}
...
//func (bs *HNSBlockScanner) SetScanBlockTaskOrigin() {
//	bs.SetTask(bs.ScanBlockTaskOrigin)
//}
//
////ScanBlockTask 扫描任务
//func (bs *HNSBlockScanner) ScanBlockTaskOrigin() {
//
//	//获取本地区块高度
...
//
//				//通知分叉区块给观测者，异步处理
//				bs.NewHNSBlockNotify(forkBlock, isFork)
//			}
//
//		} else {
//
...
//
//			//通知新区块给观测者，异步处理
//			bs.NewHNSBlockNotify(block, isFork)
//		}
//
//	}
//
...
//func (bs *HNSBlockScanner) ScanTxMemPoolOrigin() {
//
...
//
//	//通知内存池交易单给观测者
//	bs.NewHNSBlockNotify(block, false)
//}
//
////BatchExtractTransaction 批量提取交易单
////handshake 1M的区块链可以容纳3000笔交易，批量多线程处理，速度更快
//func (bs *HNSBlockScanner) BatchExtractTransactionOrigin(block *Block) error {
//
//	var (
//		done       = 0 //完成标记
...
//
////AddObserver 添加观测者
//func (bs *HNSBlockScanner) AddHNSBlockObserver(obj HNSBlockScanNotificationObject) error {
//	bs.Mu.Lock()
//
//	defer bs.Mu.Unlock()
//
...
//		return nil
//	}
//	if _, exist := bs.HNSBlockObservers[obj]; exist {
//		//已存在，不重复订阅
//		return nil
//	}
//
//	bs.HNSBlockObservers[obj] = true
//
//	return nil
//}
//
////RemoveObserver 移除观测者
//func (bs *HNSBlockScanner) RemoveHNSBlockObserver(obj HNSBlockScanNotificationObject) error {
//	bs.Mu.Lock()
//	defer bs.Mu.Unlock()
//
//	delete(bs.HNSBlockObservers, obj)
//
//	return nil
//}
//
////newBlockNotify 获得新区块后，通知给观测者
//func (bs *HNSBlockScanner) NewHNSBlockNotify(block *Block, isFork bool) {
//	block.Fork = isFork
//	for o, _ := range bs.HNSBlockObservers {
//		o.HNSBlockScanNotify(block, block.txDetails)
//	}
//}
//
//
////GetScannedBlockHeader 获取当前扫描的区块头
//func (bs *HNSBlockScanner) GetScannedBlockHeaderOrigin() (*openwallet.BlockHeader, error) {
//
//	var (
